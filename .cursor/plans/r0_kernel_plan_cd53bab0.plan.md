---
name: R0 Kernel Plan
overview: Final R0 kernel plan — Git-tracked YAML objects, Pydantic validation, human Review plus semantic subject_digest for claim acceptance, rebuildable project SQLite, noncanonical project_registry.sqlite. Ready for implementation once this amendment set is acknowledged.
todos:
  - id: approve-revised-plan
    content: Explicit go-ahead to implement this final amended R0 plan
    status: pending
  - id: m1-docs-foundation
    content: "M1: docs + AGENTS.md + CAPSULE.md + paths.py + PyYAML/pydantic + pytest/ruff + doctor writability"
    status: pending
  - id: m2-models-validate
    content: "M2: ids, Pydantic models, semantic digests, transition graphs, validators, unit tests"
    status: pending
  - id: m3-cli-capsule
